...
\begin{tabularx}{\textwidth}{l X l}
	...
	\hspace{-8pt}\multirow{6}{*}{
		\begin{tabular}{l}
			...
			TVA intracom: \VAR{invoice.issuer.intracom_vat}
		\end{tabular}}
	\BLOCK{endblock}
	 &
	 &
	...
	\multirow{3}{*}{
		\begin{tabular}{l}
			...
			\BLOCK{endif}
			\BLOCK{if invoice.customer.email}\VAR{invoice.customer.email.replace('_', '\_')}\BLOCK{endif} \\
			\BLOCK{if invoice.customer.phone}tel: \VAR{invoice.customer.phone}\BLOCK{endif}               \\
		\end{tabular}
	}
	\BLOCK{endblock}
\end{tabularx}
